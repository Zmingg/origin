...
exports.default = {
	data: function data() {
		return {
			...
			datas: [{ title: 'QC BLOG —— For Web Technology Share', src: 'apps/assets/img/bing-1.jpg' }, { title: 'Laravel —— 为WEB艺术家创造的PHP框架', src: 'apps/assets/img/bing-2.jpg' }, { title: 'Vue.Js 2.0 渐进式JavaScript 框架', src: 'apps/assets/img/bing-3.jpg' }]
