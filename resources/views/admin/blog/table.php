    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="index.html"><i class="fa fa-th-large"></i> <span class="nav-label">中心首页</span> <span class="fa arrow"></span></a>
                ...
                <li class="active">
                    <a href="table_data_tables.html#"><i class="fa fa-table"></i> <span class="nav-label">内容管理</span><span class="fa arrow"></span></a>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=URL::asset('ass_back')?>/img/a7.jpg">
                                </a>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=URL::asset('ass_back')?>/img/a4.jpg">
                                </a>
                                <div class="media-body ">
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="<?=URL::asset('ass_back')?>/img/profile.jpg">
                                </a>
                                <div class="media-body ">
